<template>
    <div>
        ...
        <el-form v-model="createForm" label-width="150px" style="width: 600px">
            ...
            <el-form-item label="Date of Birth">
                <el-date-picker type="date" placeholder="Pick a date" v-model="createForm.DoB" />
            </el-form-item>
            ...
            <el-form-item label="Role">
                <el-select placeholder="Select a role" v-model="createForm.role">
            ...
            <el-form-item v-if="createForm.role == 'Employee' || createForm.role == 'Trainee'" label="Superior">
                <el-select v-model="createForm.superior">
